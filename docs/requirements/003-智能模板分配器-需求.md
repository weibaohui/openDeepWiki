...
type Repository struct {
    ...
    URL          string     `json:"url" gorm:"size:500;not null;default:''"`
    LocalPath    string     `json:"local_path" gorm:"size:500;default:''"`
    Description  string     `json:"description" gorm:"size:1000;default:''"`
    Status       string     `json:"status" gorm:"size:50;default:pending"`
    ErrorMsg     string     `json:"error_msg" gorm:"size:1000;default:''"`
