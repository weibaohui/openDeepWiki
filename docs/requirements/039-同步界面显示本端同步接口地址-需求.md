...
**规则说明：**
- 协议：根据当前环境判断，例如生产环境使用 `https`，开发环境可使用 `http`
...
**入口：** 同步页面右上角新增“历史记录”按钮  
**展示形式：** 抽屉弹窗（Drawer），表格倒序显示  
**表格字段：**
- 同步时间
- 同步模式（pull / push）
- 目标服务器
